...
- [1. 專案概述](#1-專案概述)
- - [2. 系統架構](#2-系統架構)
  - - [3. Chat Agent 設計](#3-chat-agent-設計)
    - - [4. API 規格](#4-api-規格)
      - - [5. 前端實作規格](#5-前端實作規格)
        - - [6. UI 元件設計](#6-ui-元件設計)
          - - [7. 實作流程](#7-實作流程)
            ...
            | Stage | 用戶狀態 | 系統行為 | Mlytics 介入程度 |
            |-------|---------|---------|-----------------|
            | **Discovery** | 被動閱讀 | 文章內嵌 AIGC Widget | 開始介入 |
            | **Engagement** | 主動提問 | 顯示 Quick Question Chips + 開啟對話 | 深度介入 |
            | **Intent Qualification** | 探索解決方案 | 透過對話捕捉 intent signals | 深度介入 |
            | **Conversion Bridge** | 考慮購買 | 呈現產品推薦卡片 | 變現點 |
